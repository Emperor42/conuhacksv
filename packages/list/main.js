    ...
    var ListEventRenderer = /** @class */ (function (_super) {
        ...
        ListEventRenderer.prototype.renderSegHtml = function (seg) {
            ...
            return '<tr class="' + classes.join(' ') + '">' +
                ...
                '<img onclick="checkh()" id="check" src="Images/List-Buttons/check-hover.png" alt="check" width="22" height="22" align="right">'+
                '<img onclick="clearh()" id="clear" src="Images/List-Buttons/clear-hover.png" alt="clear" width="22" height="22" align="right">'+
                '<img onclick="splith()" id="split" src="Images/List-Buttons/split-hover.png" alt="split" width="22" height="22" align="right">'+
                '</a>' +
                '</td>' +
